...
with dai.Device(pipeline) as device:
    ...
    while exit == 0:
        ...
        path = '/home/jetson/depthai-experiments/gen2-pointcloud/rgbd-pointcloud/images'
        cv2.imwrite(f"{path}/depth/{serial_no}_{timestamp}_depth.png", depth_vis)
        cv2.imwrite(f"{path}/color/{serial_no}_{timestamp}_color.png", color)
        cv2.imwrite(f"{path}/{serial_no}_{timestamp}_rectified_left.png", rectified_left)
        cv2.imwrite(f"{path}/{serial_no}_{timestamp}_rectified_right.png", rectified_right)
        o3d.io.write_point_cloud(f"{path}/{serial_no}_{timestamp}.pcd", pcl_converter.pcl, compressed=True)
        
        print("finished writting  key")
        exit = 1
    ...
    """ 
            ...
            if key == ord('s'):
                timestamp = str(int(time.time()))
                cv2.imwrite(f"/home/jetson/depthai-experiments/gen2-pointcloud/rgbd-pointcloud/images/depth/{serial_no}_{timestamp}_depth.png", depth_vis)
                cv2.imwrite(f"/home/jetson/depthai-experiments/gen2-pointcloud/rgbd-pointcloud/images/color/{serial_no}_{timestamp}_color.png", color)
                cv2.imwrite(f"/home/jetson/depthai-experiments/gen2-pointcloud/rgbd-pointcloud/images/{serial_no}_{timestamp}_rectified_left.png", rectified_left)
                cv2.imwrite(f"/home/jetson/depthai-experiments/gen2-pointcloud/rgbd-pointcloud/images/{serial_no}_{timestamp}_rectified_right.png", rectified_right)
                print("s  key")
                o3d.io.write_point_cloud(f"/home/jetson/depthai-experiments/gen2-pointcloud/rgbd-pointcloud/images/{serial_no}_{timestamp}.pcd", pcl_converter.pcl, compressed=True)
                break
    """