...
with dai.Device(pipeline) as device:
    ...
    while True:
        ...
        if key == ord("s"):
            ...
            pcl_converter.pcl.estimate_normals()
            mesh, _ = o3d.geometry.TriangleMesh.create_from_point_cloud_poisson(pcl_converter.pcl)
            o3d.io.write_triangle_mesh('o_mesh.obj', mesh)
            break
        elif key == ord("q"):
